  ...
  features = [
    {
      ...
      image: "https://assets.zyrosite.com/cdn-cgi/image/format=auto,w=1039,h=636,fit=crop/YbNaP4oDnWC621jn/img-20240121-wa0028-m5Kv5kW191i7koel.jpg",
    ...
    <section className="pb-20">
      <div className="container flex flex-col lg:gap-16 gap-10 lg:px-36 mx-auto">
        <div className="text-center mt-14 bg-gray-200 py-10">
          ...
          <p className="lg:text-3xl lg:px-44 font-serif text-gray-800 px-5">
            Welcome to{" "}
            <span className="text-red-700">
              Elijah&apos;s Fire Faith Ministry and Yes4save Foundation
            </span>
            , where our mission is to ignite the fire of God’s Spirit through
            evangelism, revival events and humanitarian outreach. We are dedicated
            to transforming lives, spreading the Gospel and bringing hope to those
            in need.
          </p>
        </div>
          ...
          {features.slice(0).map((feature) => (
            ...
            >
              ...
              <div className="px-6 py-8 md:px-8 md:py-10 lg:px-10 lg:py-12">
                ...
                <p className="text-gray-800 lg:text-xl font-serif">
                  {feature.description}
                </p>
              </div>
            </div>
